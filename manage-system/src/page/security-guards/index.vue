  ...
  <section class="super-administrator">
    <div style="width: 90%">
      <el-table :data="tableData" style="width: 100%" height="700" border>
        ...
        <el-table-column label="是否访客" align="center">
          <template slot-scope="scope">
    ...
    <el-dialog title="新增车辆信息" :visible.sync="dialogFormVisible">
      <el-form :model="form" ref="addRef" :rules="rules">
        ...
        <el-form-item label="到期时间" :label-width="formLabelWidth" prop="jrtime">
          <el-date-picker v-model="form.jrtime" value-format="yyyy-MM-dd" type="date" placeholder="选择日期">
          </el-date-picker>
        </el-form-item>
      ...
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          const params = {
            ...this.form,
            lktime: '',
            user:JSON.parse(localStorage.getItem('userInfo'))[0].username
          }
